...
const StatisticsVisual = () => {
    ...
    useLayoutEffect(() => {
        ...
        routes.forEach((path, i) => {
            ...
            maskPath.setAttribute("stroke-width", String(strokeWidth * 4));
