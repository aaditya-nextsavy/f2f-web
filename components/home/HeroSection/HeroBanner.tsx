...
export default function HeroBanner({ title, description, actions, video, placeholder }: HeroBannerProps) {
    return (
        <section style={{ background: "var(--mobile-hero-gradient)" }} className="relative isolate  max-h-[100vh] 2xl:min-h-[680px] h-screen md:h-screen w-full overflow-hidden bg-(--mobile-hero-gradient)">
