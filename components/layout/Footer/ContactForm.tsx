      ...
      <div className="grid gap-5 sm:grid-cols-2">
        <FormField label="First Name" required error={errors.firstName}>
          <input
            ...
            className={`${fieldControlClass} ${errorInputClass("firstName")}`}
          />
        </FormField>
        ...
        <FormField label="Last Name" required error={errors.lastName}>
          <input
            ...
            className={`${fieldControlClass} ${errorInputClass("lastName")}`}
          />
        </FormField>
        ...
        <FormField label="Contact Number" required error={errors.contactNumber}>
          <input
            ...
            className={`${fieldControlClass} ${errorInputClass("contactNumber")}`}
          />
        </FormField>
        ...
        <FormField label="Email" required error={errors.email}>
          <input
            ...
            className={`${fieldControlClass} ${errorInputClass("email")}`}
          />
        </FormField>
